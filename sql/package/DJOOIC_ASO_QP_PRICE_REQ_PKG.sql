--------------------------------------------------------
--  DDL for Package DJOOIC_ASO_QP_PRICE_REQ_PKG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "APPS"."DJOOIC_ASO_QP_PRICE_REQ_PKG" 
AS
-- Package name     : DJOOIC_ASO_QP_PRICE_REQ_PKG
